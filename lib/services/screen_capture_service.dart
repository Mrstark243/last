...
class ScreenCaptureService {
  ...
  final bool _isFirstCapture = true;
  static const int _captureInterval = 100; // Set to 100ms for smoother updates
  static const int _debounceDuration =
      50; // Set to 50ms for better responsiveness
  ...
  final int _lastCaptureTime = 0;
  static const int _minCaptureInterval =
      50; // Minimum time between captures in ms
  ...
  void startCapturing() {
    ...
    _captureTimer =
        Timer.periodic(const Duration(milliseconds: _captureInterval), (timer) {
      if (_isCapturing) {
        _captureScreen();
      }
    });
